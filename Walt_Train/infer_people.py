...
def main():
    detect = detections('configs_local/swin/occ_mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_adamw_1x_people_real_coco.py', 'cuda:0', model_path='work_dirs/occ_mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_adamw_1x_people_real_coco/latest.pth')
    ...
    for filename in filenames:
        ...
        count=count+1
        print(filename.replace('demo','demo/results_ours/'),'result_' + filename)
        import os
        ...
        cv2.imwrite(filename.replace('demo','demo/results_ours/'),img)
        if count == 30000:
            break
